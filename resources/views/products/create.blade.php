...
<main class="catalog-main"><section class="catalog-heading"><div><p class="catalog-eyebrow">Authenticated inventory</p><h1>Add product</h1><p class="catalog-lead">Create a product with a valid name, quantity, and price.</p></div><a class="catalog-button" href="{{ route('product/index') }}">Back to products</a></section>
...
<form class="catalog-form" action="{{ route('product/store') }}" method="POST">
    @csrf
    <div class="catalog-field"><label for="name">Product name</label><input id="name" type="text" name="name" value="{{ old('name') }}" placeholder="Enter product name" required></div>
    <div class="catalog-field"><label for="quantity">Quantity</label><input id="quantity" type="number" min="0" step="1" name="quantity" value="{{ old('quantity') }}" placeholder="0" required></div>
    <div class="catalog-field"><label for="price">Price</label><input id="price" type="number" min="0" step="0.01" name="price" value="{{ old('price') }}" placeholder="0.00" required></div>
    <button class="catalog-button" type="submit">Save product</button>
</form></main>
